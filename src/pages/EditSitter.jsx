    ...
    const fetchProfile = async () => {
      try {
        ...
        if (data.sitterImage && data.sitterImage !== 'default.png') {
          setProfileImage(`${API}/api/auth/images/${data.sitterImage}`);
          setProfileFileName(data.sitterImage);
        }
        if (data.qrCodeImage && data.qrCodeImage !== 'default.png') {
          setQrImage(`${API}/api/auth/images/${data.qrCodeImage}`);
    ...
    <div>
      ...
      <div className="ar-page">
        <div className="ar-card">
          <div className="ar-form-title ar-sitter">แก้ไขข้อมูล ผู้ดูแลสัตว์เลี้ยง</div>
                ...
                <div style={{display:'flex', gap:14, alignItems:'flex-start'}}>
                  ...
                  <div style={{flex:1, display:'flex', flexDirection:'column', gap:9}}>
                    ...
                    <div className="ar-row-2">
                      <div className="ar-field">
                        <label>รหัสผ่าน <span style={{color:'#aaa',fontSize:11}}>(ไม่สามารถแก้ไขได้)</span></label>
                        <input type="password" value="••••••••" disabled style={{background:'#f5f0ed',color:'#999',cursor:'not-allowed'}} />
                      </div>
                      <div className="ar-field">
                        <label>ยืนยันรหัสผ่าน <span style={{color:'#aaa',fontSize:11}}>(ไม่สามารถแก้ไขได้)</span></label>
                        <input type="password" value="••••••••" disabled style={{background:'#f5f0ed',color:'#999',cursor:'not-allowed'}} />
                      </div>
                    </div>
                  </div>
