...
function RegisterSitter() {
  ...
  const validate = () => {
    ...
    else if (password !== confirmPassword) e.confirmPassword = 'รหัสผ่านไม่ตรงกัน';
    ...
    else if (isNaN(rate) || Number(rate) <= 0) e.rate = 'ค่าดูแลต้องเป็นตัวเลขที่มากกว่า 0';
  ...
  const handleRegister = async () => {
    ...
    try {
      const jsonData = {
        ...
        addressNo: addressNo.trim(), street: street.trim() || '-',
        ...
        bankName: bank, accountNo: accountNo.trim(), accountName: accountName.trim(),
      };
      ...
      if (!res.ok) { alert(data.message || 'ไม่สามารถลงทะเบียนได้ กรุณาลองใหม่อีกครั้ง'); return; }

      const imageForm = new FormData();
      imageForm.append('sitterImage', profileFile);
      imageForm.append('qrCodeImage', qrFile);
      await fetch(`${API}/api/auth/upload-sitter-image/${data.sitterID}`, { method: 'POST', body: imageForm });
      ...
      <div className="ar-page">
        <div className="ar-card">
                  ...
                  <div style={{flex:1, display:'flex', flexDirection:'column', gap:9}}>
                    ...
                    <div style={{display:'flex', gap:8, alignItems:'flex-start'}}>
                      <div className="ar-field" style={{flex:1}}>
                        ...
                        <input type="text" value={firstName} placeholder="ชื่อ" onChange={e => { setFirstName(e.target.value); setErrors(p => ({...p,firstName:''})); }} />
                        {errors.firstName && <p className="ar-error">{errors.firstName}</p>}
                      </div>
                      <div className="ar-field" style={{flex:1}}>
                        <label>นามสกุล <span className="ar-req">*</span></label>
                        <input type="text" value={lastName} placeholder="นามสกุล" onChange={e => { setLastName(e.target.value); setErrors(p => ({...p,lastName:''})); }} />
                    ...
                    <div className="ar-row-3">
                      ...
                      <div className="ar-field">
                        ...
                        <input type="text" value={phone} placeholder="0621234567" maxLength={10} onChange={e => { setPhone(e.target.value); setErrors(p => ({...p,phone:''})); }} />
                        {errors.phone && <p className="ar-error">{errors.phone}</p>}
                      </div>
                      <div className="ar-field">
                        <label>อีเมล <span className="ar-req">*</span></label>
                        <input type="text" value={email} placeholder="email@example.com" onChange={e => { setEmail(e.target.value); setErrors(p => ({...p,email:''})); }} />
                    ...
                    <div className="ar-row-2">
                      <div className="ar-field" style={{position:'relative'}}>
                        ...
                        <input
                          type="password" value={password} placeholder="กรอกรหัสผ่าน"
                        ...
                        {showPwHint && (
                          <div style={{
                            ...
                            padding:'8px 12px', fontSize:11, color:'#1E4D6B',
              ...
              <div className="ar-section-box">
                ...
                <div className="ar-row-2" style={{marginBottom:10}}>
                  <div className="ar-field">
                    ...
                    <input type="text" value={addressNo} placeholder="เช่น 411" onChange={e => { setAddressNo(e.target.value); setErrors(p => ({...p,addressNo:''})); }} />
              ...
              <div className="ar-section-box">
                ...
                <div className="ar-row-2">
                  ...
                  <div className="ar-field">
                    ...
                    <input type="number" value={rate} placeholder="100" min="1" onChange={e => { setRate(e.target.value); setErrors(p => ({...p,rate:''})); }} />
              ...
              <div className="ar-section-box">
                ...
                <div className="ar-row-2">
                  ...
                  <div className="ar-field">
                    ...
                    <input type="text" value={accountNo} placeholder="012-3-456789" onChange={e => { setAccountNo(e.target.value); setErrors(p => ({...p,accountNo:''})); }} />
                    {errors.accountNo && <p className="ar-error">{errors.accountNo}</p>}
                  </div>
                </div>
                <div className="ar-field" style={{marginBottom:10}}>
                  <label>ชื่อบัญชี <span className="ar-req">*</span></label>
                  <input type="text" value={accountName} placeholder="ชื่อ-นามสกุล" onChange={e => { setAccountName(e.target.value); setErrors(p => ({...p,accountName:''})); }} />
                ...
                <div className="ar-field">
                  ...
                  <div className="ar-qr-upload-box" onClick={() => qrRef.current.click()}>
                    {qrImage ? <img src={qrImage} alt="QR" className="ar-qr-preview" /> : <><span style={{fontSize:32,color:'#3A7CA5'}}>☁️</span><p style={{fontSize:12,color:'#999',marginTop:4}}>คลิกเพื่ออัพโหลด QR Code</p></>}
                  </div>
          ...
          <div className="ar-btn-group">
            ...
            <button className="ar-btn-submit ar-sitter-btn" onClick={handleRegister} disabled={submitting}>
